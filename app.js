...
async function saveAdminWebsiteProject(clientId,projectId){
  ...
  const btn=$(`[data-action="save-admin-website-project"]`);setBusy(btn,true,"Saving…");
  try{
  ...
  }catch(e){toast(e.message||"Could not save project settings")}finally{setBusy(btn,false)}
}
